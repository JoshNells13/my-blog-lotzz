    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-gray-900 border-r border-gray-800 fixed h-screen overflow-y-auto">
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href="#categories" class="flex items-center gap-3 px-4 py-3 rounded text-gray-400 hover:text-white hover:bg-gray-800 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" class="flex items-center gap-3 px-4 py-3 rounded text-gray-400 hover:text-white hover:bg-gray-800 transition mt-8">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
